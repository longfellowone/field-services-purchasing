 ...
 * @const
 * @type {!grpc.web.AbstractClientBase.MethodInfo<
 *   !proto.server.ProcessOrderRequest,
 *   !proto.server.ProcessOrderResponse>}
 */
const methodInfo_Supply_ProcessOrder = new grpc.web.AbstractClientBase.MethodInfo(
  proto.server.ProcessOrderResponse,
  /** @param {!proto.server.ProcessOrderRequest} request */
  function(request) {
    return request.serializeBinary();
  },
  proto.server.ProcessOrderResponse.deserializeBinary
);


/**
 * @param {!proto.server.ProcessOrderRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.server.ProcessOrderResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.server.ProcessOrderResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.server.SupplyClient.prototype.processOrder =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/server.Supply/ProcessOrder',
      request,
      metadata || {},
      methodInfo_Supply_ProcessOrder,
      callback);
};
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.server.ProcessOrderResponse>}
 *     A native promise that resolves to the response
 */
proto.server.SupplyPromiseClient.prototype.processOrder =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/server.Supply/ProcessOrder',
      request,
